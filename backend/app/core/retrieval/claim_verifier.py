...
# Prompt for atomic claim extraction (based on InFact, LegalReasoner research)
_CLAIM_EXTRACTION_PROMPT = """You are a legal fact-checker. Decompose the following legal answer into atomic, verifiable claims.
...
# Prompt for claim verification against evidence (based on InFact 6-stage process)
_CLAIM_VERIFICATION_PROMPT = """You are a legal fact-checker. Verify the following claim against the provided evidence.
...
# Prompt for overall groundedness scoring
_GROUNDEDNESS_PROMPT = """You are a legal fact-checker. Assess the overall groundedness of this legal answer based on claim-level verifications.
