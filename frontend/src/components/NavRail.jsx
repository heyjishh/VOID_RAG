...
import { MessagesSquare, FilePen, Settings, LogOut, ChevronDown } from 'lucide-react'
import { logout, getDisplayName } from '../lib/session.js'

export default function NavRail({ mode, onModeChange, onSettingsClick, user, onLogout }) {
  ...
  return (
    <nav
      className="flex flex-col items-center flex-shrink-0 relative z-40"
      style={{
        width: 64,
    ...
    >
      {/* Brand mark — links back to the landing site */}
      <div
      ...
      >
        <a
          ...
          title="JuryAI — back to our site"
          aria-label="JuryAI home"
        >
